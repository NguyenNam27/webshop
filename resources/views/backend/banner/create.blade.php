        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> Thêm Thông Tin Banner </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body"> 
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                              ...
                              <input required type="text" class="form-control" id="title" name="title" placeholder="Nhập tên danh mục">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                              ...
                              <input required type="date" class="form-control" id="created_at" name="created_at" placeholder="Nhập ngày thêm">
                        </div>
