...
@section('content')
    <section class="content-header">
        <h1>
           Quản Lý Danh Sách - Danh Mục <a href="{{route('admin.category.create')}}" class="btn btn-primary"> Thêm danh mục </a>
        </h1>
        <ol class="breadcrumb">
                ...
                @foreach($category as $key => $row)
                    <tr >
                        ...
                        <td class="text-center">
                            <a href="{{route('admin.category.edit',['id'=>$row->id])}}" class="btn btn-flat bg-purple"><i class="fa fa-pencil"></i></a>
